...
const SITE_INDEX = [
  ...
  { title: "省内其他地市公告索引", url: "/notice/city-other.html", desc: "齐齐哈尔、牡丹江、佳木斯、大庆等" },
  { title: "医疗岗E类公告合集", url: "/notice/medical.html", desc: "医院、医疗卫生系统招聘公告" },
  { title: "教师岗D类公告合集", url: "/notice/teacher.html", desc: "学校、教育系统招聘公告" },
  { title: "岗位选择指南", url: "/notice/job-selection-guide.html", desc: "各地市竞争比、选岗策略" },
  { title: "报名人数统计", url: "/notice/signup-stats.html", desc: "热门岗位、竞争比跟踪" },
  { title: "岗位深度拆解：街道办综合岗", url: "/notice/job-analysis-street.html", desc: "真实工作内容、待遇、发展前景" },
  ...
  { title: "应届生择业期怎么界定", url: "/qa/graduate-definition.html", desc: "黑龙江事业单位应届生身份认定政策" },
  ...
  { title: "职测言语理解题型精讲", url: "/written/verbal-analysis.html", desc: "逻辑填空、片段阅读、语句表达逐题解析" },
  { title: "职测判断推理题型精讲", url: "/written/reasoning-analysis.html", desc: "图形推理、定义判断、类比推理、逻辑判断" },
  { title: "综应A类题型精讲", url: "/written/comprehensive-analysis.html", desc: "归纳概括、提出对策、应急处理、公文写作" },
  ...
  { title: "面试真题逐题精讲", url: "/interview/question-analysis.html", desc: "综合分析、人际沟通、应急处理答题框架" },
...
function initCountdown() {
  ...
  if (!daysEl) return;
  // 2026年10月17日笔试
  const target = new Date('2026-10-17T09:00:00+08:00').getTime();
  function update() {
    const now = Date.now();
